...
#df_new = pd.read_csv(r"Raw_Datasets\Founta_18\Founta_Raw_Dataset_Multi.csv", encoding='latin1')
#writer = pd.ExcelWriter(r"Raw_Datasets\Founta_18\Founta_Raw_Dataset_Multi.xlsx")
#df_new.to_excel(writer, index = False)
#writer.save()


wb = load_workbook(r"Raw_Datasets\HateXplain\HateXplain.xlsx")
sheet = wb["Sheet1"]
rows = sheet.max_row
...
tweets.to_csv(r"Pre_Processed_Data_Sets\Preprocess_CSV\HateXplain\HateXplain_Multi_Preprocess.csv", sep=',', index=False, encoding='utf-8')

# #Below code is to convert CSV to Excel.
df_new = pd.read_csv(r"Pre_Processed_Data_Sets\Preprocess_CSV\HateXplain\HateXplain_Multi_Preprocess.csv")
writer = pd.ExcelWriter(r"Pre_Processed_Data_Sets\Preprocess_Excel\HateXplain\HateXplain_Multi_Preprocess.xlsx")
df_new.to_excel(writer, index = False)
writer.save()
